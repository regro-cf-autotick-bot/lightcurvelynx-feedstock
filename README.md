...
pixi add lightcurvelynx
# for installing globally
pixi global install lightcurvelynx
```
...
It is possible to list all of the versions of `lightcurvelynx` available on your platform:
...
```
pixi search lightcurvelynx --channel conda-forge
```
